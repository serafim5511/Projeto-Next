...
namespace NextForms
{
    class Client
    {
        ...
        public static HttpResponseMessage PUT<T>(string urlAPI, string metodo, T parametros, string token = null)
        {
            ...
            try
            {
                return client.PutAsync(metodo, CreateHttpContent<T>(parametros)).GetAwaiter().GetResult();
            }
            catch
            {
                throw new Exception("Erro ao consultar API " + urlAPI + " Método: " + metodo);
        ...
        public static HttpResponseMessage DELETE(string urlAPI, string metodo, Dictionary<string, string> parametros, string token = null)
        {
            ...
            try
            {
                return client.DeleteAsync(metodo).GetAwaiter().GetResult();
            }
            catch
            {
                throw new Exception("Erro ao consultar API " + urlAPI + " Método: " + metodo);
